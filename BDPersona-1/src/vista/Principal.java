...
public class Principal extends javax.swing.JFrame {
    ...
    private void switchHabilitar(boolean flag){
        ...
        jTApellido.setEditable(flag);
        jTSeguridadS.setEditable(flag);
    ...
    private boolean guardar(){
        JTextField [] campos = {jTNombre, jTApellido, jTNumeroDoc, jTSeguridadS};
        boolean sonVacios = Validador.estanVacios(campos);
        if(!sonVacios){
            if(Validador.validarNumero(jTSeguridadS)){
                String doc = jTNumeroDoc.getText().trim();
                int ss = Integer.parseInt(jTSeguridadS.getText().trim());
                String nom = jTNombre.getText().trim();
                String apel = jTApellido.getText().trim();
                usuario = new Usuario(doc, ss, nom, apel);
                int resultado = ctrl.agregar(usuario);
                if(resultado > 0){
                    Mensaje.mensajeInfo("Guardado", "Usuario agregado");
                    return true;
                }
            }
        }
    ...
    private void initComponents() {
        ...
        jTSeguridadS = new javax.swing.JTextField();
        ...
        jLabel1.setText("Seguridad Social:");

        jTSeguridadS.setEditable(false);
        jTSeguridadS.setName("Seguridad Social"); // NOI18N
        jTSeguridadS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTSeguridadSActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jTSeguridadS, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
    ...
    private void jTSeguridadSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTSeguridadSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTSeguridadSActionPerformed
    ...
    private javax.swing.JTextField jTSeguridadS;
